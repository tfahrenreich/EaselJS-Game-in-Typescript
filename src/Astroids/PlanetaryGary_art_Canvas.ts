...
// symbols:
    ...
    (lib.StartBtn = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get({}).to({
            state: [{
                t: this.shape_22,
                p: {scaleX: 0.366, scaleY: 0.366, x: -6.7}
            }, {t: this.shape_21, p: {scaleX: 0.366, scaleY: 0.366, x: -6.7}}, {
                t: this.shape_20,
                p: {scaleX: 0.366, scaleY: 0.366, y: 9.9}
            }, {
                t: this.shape_19,
                p: {scaleX: 0.366, scaleY: 0.366, x: -7.2, y: -23.3}
            }, {t: this.shape_18}, {t: this.shape_17}, {t: this.shape_16}, {t: this.shape_15}, {t: this.shape_14}, {t: this.shape_13}, {t: this.shape_12}, {t: this.shape_11}, {t: this.shape_10}, {t: this.shape_9}, {t: this.shape_8}, {t: this.shape_7}, {t: this.shape_6}, {t: this.shape_5}, {t: this.shape_4}, {t: this.shape_3}, {t: this.shape_2}, {t: this.shape_1}, {t: this.shape}]
        }).to({
            state: [{t: this.shape_22, p: {scaleX: 0.402, scaleY: 0.402, x: -6.6}}, {
                t: this.shape_21,
                p: {scaleX: 0.402, scaleY: 0.402, x: -6.6}
            }, {t: this.shape_20, p: {scaleX: 0.402, scaleY: 0.402, y: 11.1}}, {
                t: this.shape_19,
                p: {scaleX: 0.402, scaleY: 0.402, x: -7.3, y: -25.4}
            }, {t: this.shape_41}, {t: this.shape_40}, {t: this.shape_39}, {t: this.shape_38}, {t: this.shape_37}, {t: this.shape_36}, {t: this.shape_35}, {t: this.shape_34}, {t: this.shape_33}, {t: this.shape_32}, {t: this.shape_31}, {t: this.shape_30}, {t: this.shape_29}, {t: this.shape_28}, {t: this.shape_27}, {t: this.shape_26}, {t: this.shape_25}, {t: this.shape_24}, {t: this.shape_23}]
        }, 1).to({
            state: [{t: this.shape_22, p: {scaleX: 0.349, scaleY: 0.349, x: -6.7}}, {
                t: this.shape_21,
    ...
    (lib.ScoreboardNumbers = function (mode, startPosition, loop) {
        ...
        // Numbers
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#E0C924").s().p("AgbCYQg4gNgSg8QgQg4AYg6QANggAVggQAfgwAWAAQAGgJAHAEQAwAVAdAyQAeA0gHA4QgHA2goAoQghAhgjAAQgJAAgKgCgAgvg8QgVAtgDASQgKA2AdAlQAgAoAqgfQAfgXANglQAPgogOgkQgJgYgYgZIgmgqQgSAKgZA2g");
        this.shape.setTransform(10.9, 15.5);

        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#E0C924").s().p("AgSCUQAAhfASinQgJALgIAEQgHAEgEgHQgFgHAFgHIAUgZQAJgPAJgJQAGgGAHAGQAFAFABAJQAFA5gJBdQgLB0gBAhQAAAVgPAAQgRgBABgUg");
        this.shape_1.setTransform(3.2, 17);

        this.shape_2 = new cjs.Shape();
        this.shape_2.graphics.f("#E0C924").s().p("AAuCiQgUgBhlgCQgJAAgEgJQgFgJAEgJQANgeA3hHQAsg7ALgwQAMg4gsAKQgcAHgxAhQAEABAAAEQAAADgEABIgSAEQgFACgDgFQgDgFACgFQARgnA8gcQA+geAWApQAXAtgqBUQgNAZgdApQgiAugLAUIBCACQAoAAAbgGQAJgCAGAIQAGAIgGAIQgJAPgPAFQgHACgLAAIgNgBg");
        this.shape_2.setTransform(10.4, 16.3);

        this.shape_3 = new cjs.Shape();
        this.shape_3.graphics.f("#E0C924").s().p("");
        this.shape_3.setTransform(11.2, 16.5);

        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#E0C924").s().p("AA5CfIgDh3QgcALgqgJQgmgIgagQQgEgCgDgEQgCgFAAgEIAMhYQAIgzATgjQACgEAFACQAEACgBAFQgFAhgEAvIgFBRQAaAKAcADQAfACAWgKQgBhVANg/QABgFAHAAQAGAAACAFQAGAhABAtIgCBLQgBAfACAtIACBMQADAQgSABIgCAAQgPAAAAgPg");
        this.shape_4.setTransform(9, 17.5);

        this.shape_5 = new cjs.Shape();
        this.shape_5.graphics.f("#E0C924").s().p("");
        this.shape_5.setTransform(10.9, 17.5);

        this.shape_6 = new cjs.Shape();
        this.shape_6.graphics.f("#E0C924").s().p("AhZBqQgNg5AZhBQAVg2AegvQAuhIAjARQADACAAADQAAAEgDABQgXAKgUAbIgbAyIgVAmQAhgCAkATQAmATAMAVQAZAvgcA1QgcA3g2ABIgDAAQhFAAgPhGgAg0ASQgEAGgFABQgGAaACAYQAFA4AvAKQAtAJAWg0QAMgbgLgaQgKgYgcgOQgUgJgQAAQgXAAgKAUg");
        this.shape_6.setTransform(9.5, 17.7);

        this.shape_7 = new cjs.Shape();
        this.shape_7.graphics.f("#E0C924").s().p("AgfCeQABhuAbg8IAbg+QARgmAHgbQgVgIglABQgwACgOgCIgCAAQgFgCgBgGQgBgGAHgBQAtgLAdgCQAsgCAeAPQAIAEAAAKQgBAcgQAmIgdA+QgfBJgBBoQAAARgRAAQgSAAAAgRg");
        this.shape_7.setTransform(8.2, 17.6);

        this.shape_8 = new cjs.Shape();
        this.shape_8.graphics.f("#E0C924").s().p("");
        this.shape_8.setTransform(10.7, 18);

        this.shape_9 = new cjs.Shape();
        this.shape_9.graphics.f("#E0C924").s().p("ABBCjQgPgggFgtQgDgiACgzQgKAHgJADQgZAJgZgHQgcgHgSgTQgTgYAAgbQgBgcASgZQAcgrArgIQApgIAjAhQAHAHgGAHQAJAEAAAMIAAASQgBCUAIBmQABALgLAEIgFAAQgHAAgEgHgAgIh/QgmAOgIAkQgEAQAHANQAHAMANAIQAjAUAYgbQAUgYACgsIAAgKQAAgJAHgGQgPgGgRAAQgRAAgQAHg");
    ...
    (lib.Scoreboard = function (mode, startPosition, loop) {
        ...
        // Layer 1
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#E0C924").s().p("AgCASQgIAAgEgGQgEgFABgHQgBgGAEgFQAEgGAIAAIACAAQAFAAAEAFIADACQAGACAAAIQAAAJgGACIgDACQgEAFgFAAg");
        this.shape.setTransform(140.1, 32.6);

        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#E0C924").s().p("AgOAMIAAAAQgGgOAIgJQAEgKAIAAQAJAAAEAKQAJAKgHANIAAAAQgDAKgMAAQgKAAgEgKg");
        this.shape_1.setTransform(138.9, 19.3);

        this.shape_2 = new cjs.Shape();
        this.shape_2.graphics.f("#E0C924").s().p("AguCGQgtgWAAgiQABgKAJgBQAQgBAXAPQAdATAJADQANAFALgDQAMgDAKgMQAQgUgIgOQgLgVgfgWQghgYgKgNQgSgWAHglQAGglAWgRQAWgSAeAKQAeAKAMAeQACAGgEAFQgEAFgFgDQg/gpgJAuQgFAWAGALQAEAGARAPQAiAZAMALQAZAZAFAcQAFAfgXAeQgWAegcACIgLABQgaAAgggQg");
        this.shape_2.setTransform(121.3, 25.7);

        this.shape_3 = new cjs.Shape();
        this.shape_3.graphics.f("#E0C924").s().p("AgKB4QgJgTgCgfIAAg0IgDhhQg3gCgdgNQgIgEAAgIQAAgIAIgDQAXgKAjAAQAUgBAmADIA1gBQAeABAVAKQAFADgBAGQAAAHgEADQgTAQgfADQgMABgqgBIgIgBQAJAfACAzIAEA4QACAigEAXQgCAJgJACIgCAAQgGAAgEgIg");
        this.shape_3.setTransform(100.6, 25.3);

        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#E0C924").s().p("AA6CLQgggWgegoQgPgUglg4QADBLgBAlQgBAKgIACQgJABgDgKQgMgjgDgyQgBgVAAhBQAAgMALgGQALgGAHAKQAUAcAkA3QAfAyAeAaQADglgEhFQgFhKADgjQABgRAOABQANAAACAQQAJBRABAtQABBIgKA3QgCAJgIADIgHACQgEAAgEgDg");
        this.shape_4.setTransform(76, 26.2);

        this.shape_5 = new cjs.Shape();
        this.shape_5.graphics.f("#E0C924").s().p("AAMBlQgPgHgHgbIgIguQgJg9AEgvQACgNAKAAQAKAAABANIAFA4QADAfAFAXQACAMAIAZQAFAWgGAOQgBADgDABIgEABIgCAAg");
        this.shape_5.setTransform(59, 30.4);

        this.shape_6 = new cjs.Shape();
        this.shape_6.graphics.f("#E0C924").s().p("AgRBrQgngOgSgmQgQghADgxQADg6AegLQACgEADgCQAigWAqAaQAqAYANApQALAhgIAlQgIAmgaAWQgSAQgXAAQgMAAgPgGgAg0gsQgEAQAAANQAAAyAfAYQASAOAPAAQAVAAALgUQALgSACgXQACgWgKgSQgNgZgbgIQgegGgQgHQgHAKgEAUg");
        this.shape_6.setTransform(41.7, 29.7);

        this.shape_7 = new cjs.Shape();
        this.shape_7.graphics.f("#E0C924").s().p("AgeCDQgLgagLg1IgFgCQgMgDAAgOQAAgOALgEQgJg/AIgnQAKgwAkgDQAkgDAbAhQAcAigKAqQgIAggWAWQgWAWgbAHIAIBDQABANgLAGQgEACgDAAQgGAAgEgIgAgYhPIAJBXQAagIAOgPQASgVgIgcQgIgbgXgHIgHgCQgQAAgFAVg");
        this.shape_7.setTransform(21.3, 27.3);

        this.shape_8 = new cjs.Shape();
        this.shape_8.graphics.f("#231F20").s().p("A2iEVIhhgLIhSgIIgCglQADgBCGAPQCNAPAlABQA1ACHTgZQHagaCKACQCQACDyANQEeAQBmADQCrAFDSgGQDxgGBAgSQAWgDCTjtQBKh4BNiBQAEgGAHADQAHACACAGQAKAciaD0QiXD0gUACQhEAThbAFQgaABiIABQj7ABhkgDQh0gDkGgNQj1gNiEgCQidgDjaANIl2AYQhcAGjbABIgpAAQixAAgugEg");
        this.shape_8.setTransform(162.5, 28.2);

        this.shape_9 = new cjs.Shape();
        this.shape_9.graphics.f("#5596A5").s().p("AGBEEQjdgcjtgCQi8gDjeANQk5ATlCAEQnDAGg1gjIAAn2MAytAAAQglBUg3BlQhtDLhXBaQh+AuinAJQhHAEh3AAQizAAkggJg");
        this.shape_9.setTransform(162.6, 27.6);

        this.timeline.addTween(cjs.Tween.get({}).to({state: [{t: this.shape_9}, {t: this.shape_8}, {t: this.shape_7}, {t: this.shape_6}, {t: this.shape_5}, {t: this.shape_4}, {t: this.shape_3}, {t: this.shape_2}, {t: this.shape_1}, {t: this.shape}]}).wait(1));

    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(0, 0, 325, 56.3);
    ...
    p.nominalBounds = new cjs.Rectangle(0, -166.4, 284.7, 166.4);
    ...
    p.nominalBounds = new cjs.Rectangle(0, -132.1, 165, 132.1);
    ...
    p.nominalBounds = new cjs.Rectangle(0, -99.2, 64.9, 99.3);
    ...
    p.nominalBounds = new cjs.Rectangle(0, -68.7, 92.4, 68.7);
    ...
    p.nominalBounds = new cjs.Rectangle(0, -70.3, 95.4, 70.3);
    ...
    p.nominalBounds = new cjs.Rectangle(0, -160, 809.7, 160);
    ...
    p.nominalBounds = new cjs.Rectangle(-400.3, -170, 800.6, 170);
    ...
    (lib.Slide = function (mode, startPosition, loop) {
        ...
        // Layer 1
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#525115").s().p("AgXA6QgOgLACgaQADgegPgaQgDgEACgFQACgEAEgBQALgCAbgKQAXgHAMAJQADACAAADQAAADgEABQgXAEgKAEIgVAIQAGAMACAPQAdgJAMAGQAGADAAAHQgBAFgFADQgFADgHABIgNACQgGABgIgBIAAAHQgCAYATgCQAMgBAZgHQAIgBACAHQABAIgGADQgPAKgUADIgKAAQgNAAgKgHg");
        this.shape.setTransform(0.9, -21.5);

        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#525115").s().p("AgOBJQgEgDAAgFQgKAFgGgJQgJgPgGgWQgPgpAIgZIABgBIgBgFQAAgHAHAAQAKgNAUgEQASgEAPAFQAYAHAMATQANAUgDAZQgEAagSAVQgSATgaAJIgDAAQgDAAgCgCgAgSgvQgOACgCAJQgCANAFAVQAGAUANAiIAAAAIALgIQAGgFAEgFQAPgRAEgMQAGgRgGgPQgHgQgUgDIgKgCIgJABg");
        this.shape_1.setTransform(-0.6, -38.2);

        this.shape_2 = new cjs.Shape();
        this.shape_2.graphics.f("#525115").s().p("AgIApQgKgRABgYQABgXAJgUQACgFAFABQAEABABAEQADAIADAbIAGAlQACAMgLAFIgGABQgFAAgFgHg");
        this.shape_2.setTransform(-2, -55.1);

        this.shape_3 = new cjs.Shape();
        this.shape_3.graphics.f("#525115").s().p("AgsAzQglgQAahSQACgGAHAAQAGAAACAGQACAKAAANIgBAXQgBASABAGQABACAJAAQATgBAcgHIAQgGQAKgDAGABQAJABAEAIQAEAJgHAHQgIAHgRAEIgbAFIgaAEIgHAAQgMAAgJgDg");
        this.shape_3.setTransform(-2.3, -69.1);

        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#525115").s().p("");
        this.shape_4.setTransform(-2.6, -88.3);

        this.shape_5 = new cjs.Shape();
        this.shape_5.graphics.f("#525115").s().p("");
        this.shape_5.setTransform(0, -56.2);

        this.shape_6 = new cjs.Shape();
        this.shape_6.graphics.f("#FEFF38").s().p("AjcE7Ij+jxQAZgfBkgcQAxgNAsgGQgsl+gXiVQA7gnEPA4QCJAdB8AkIgMHTIBTAgQBdAlArAbQgSCJmaExIAAAAQgPAAj8jtg");
        this.shape_6.setTransform(-0.7, -56);

        this.timeline.addTween(cjs.Tween.get({}).to({state: [{t: this.shape_6}, {t: this.shape_5}, {t: this.shape_4}, {t: this.shape_3}, {t: this.shape_2}, {t: this.shape_1}, {t: this.shape}]}).wait(1));

    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-50.5, -112.4, 101.1, 112.4);
    ...
    (lib.Shoot = function (mode, startPosition, loop) {
        ...
        // Layer 1
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#525115").s().p("AAgATIgdgDIgbgEQgUgDgJAFQgEACgFgEQgEgEADgEQASgVAmgBQAXgBAMACQAXADALAKQAEAEgBAEQgBAFgFAEQgJAGgQAAIgCAAg");
        this.shape.setTransform(1.4, -23.8);

        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#525115").s().p("AAFA/QgIgIgFgPQgCgJgCgTQgFgmACgUQgCgDACgEIABgBQgBgIAJgCQAIgCACAJQACAMACAWQACAXACAIIAFAbQACAPgEALQgBADgDABIgCAAQgCAAgCgCg");
        this.shape_1.setTransform(1.1, -17.4);

        this.shape_2 = new cjs.Shape();
        this.shape_2.graphics.f("#525115").s().p("AgeBAQgggOgFgeQgEgYARgcQARgaAXgIQAZgJASAWIACAFQAMAEALAMQALAMADAPQADAOgHANQgOAcgaANQgOAHgNAAQgOAAgNgGgAgfgTQgKAQACAPQACAUASAGQAQAFAPgFQARgGAHgQQAFgLgDgHQgCgLgKgGIgMgHQgHgEgDgFQgDgEAEgFIAAAAQgXADgNAWg");
        this.shape_2.setTransform(-0.5, -34.5);

        this.shape_3 = new cjs.Shape();
        this.shape_3.graphics.f("#525115").s().p("AgqA6QgUgPgDgaQgEgXAQgVQAKgNANgHQAOgJANACQAAgFADgEQANgRAVAXQAOAPAKAWQAWAvgjAcQgTAPgZABIgCAAQgXAAgSgNgAgSggQgaARAEAdQADAgAiAAQAMAAAMgFQAOgGAFgMQAGgPgNgXQgHgOgGgHQgDAFgFgDQgHgDgFAAQgJAAgJAFg");
        this.shape_3.setTransform(-0.5, -50.5);

        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#525115").s().p("AAABDQgKgFgDgSQgCgJABgTIgBghQgBgXABgMIAAgBQgEgKAJgEQAEgBAEABQACABABAEQAJAoAAAcQgBAcAHAUQADAIgHAEQgDADgEAAIgFgCg");
        this.shape_4.setTransform(3.3, -67.4);

        this.shape_5 = new cjs.Shape();
        this.shape_5.graphics.f("#525115").s().p("AAGANQgVgBgZgJQgEgCAAgCQAAgFAEgBQAJgDANAAIAUABIAUgCQAMgBAHABQAGABgCAFQgFASggAAIgCAAg");
        this.shape_5.setTransform(-3, -67.7);

        this.shape_6 = new cjs.Shape();
        this.shape_6.graphics.f("#525115").s().p("AgIA3QgDgKgCgVIgGhVQAAgJAIgCQAJgCACAHQAJAOADAXQABANABAYQABAdADAOQACAHAAADQAAAFgEAFQgBADgEAAQgNgBgGgRg");
        this.shape_6.setTransform(-7, -67.7);

        this.shape_7 = new cjs.Shape();
        this.shape_7.graphics.f("#525115").s().p("");
        this.shape_7.setTransform(-2.7, -88.3);

        this.shape_8 = new cjs.Shape();
        this.shape_8.graphics.f("#525115").s().p("");
        this.shape_8.setTransform(0, -56.2);

        this.shape_9 = new cjs.Shape();
        this.shape_9.graphics.f("#FEFF38").s().p("AjcE7Ij+jxQAagfBjgbQAxgOAsgFQgsl/gXiVQA8gnEOA4QCIAdB9AkIgMHTIBUAgQBcAlArAbQgSCJmaExIAAAAQgQAAj7jtg");
        this.shape_9.setTransform(-0.8, -56);

        this.timeline.addTween(cjs.Tween.get({}).to({state: [{t: this.shape_9}, {t: this.shape_8}, {t: this.shape_7}, {t: this.shape_6}, {t: this.shape_5}, {t: this.shape_4}, {t: this.shape_3}, {t: this.shape_2}, {t: this.shape_1}, {t: this.shape}]}).wait(1));

    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-50.5, -112.4, 101.1, 112.5);
    ...
    (lib.Jump = function (mode, startPosition, loop) {
        ...
        // Layer 1
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#525115").s().p("AgmBfQgghbALgyQgBgsAWgKQAagMAcAWQAXARAQAdQAHANAAAQQAAAPgJALQgKAMgWAFQgXADgMAEQAHAiABAVQAAAOgOACIgCAAQgMAAgEgLgAgWhHQgEAJAAATQABAWAFAYQAHgDATgCQAPgCADgCQAJgFgGgNQgHgQgMgMIgNgNQgKgHgEAAQAAAAgBAAQAAAAgBAAQAAAAAAAAQAAABgBAAg");
        this.shape.setTransform(2.3, -22.5);

        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#525115").s().p("AhDBYQgZgDABg8QAFhAAAgNQAAgLAMgCQAMgCADAMQAKAiAMAQQAMAPAKgHQAJgDAEgSQACgYADgNQAGgYAOgGQAHgDAHACQAHADACAHQAJAjANArIAIAZQAEAPAHAIQAJAJgGAKQgGAKgMgCQgPgCgJgQQgFgKgFgUIgLgrIgEAOQgMAhgZAFQgbAEgVgfIAAAFIgCAgQgCAXAFAHQACADgCAEQgCADgDAAIgBAAg");
        this.shape_1.setTransform(3.3, -43.1);

        this.shape_2 = new cjs.Shape();
        this.shape_2.graphics.f("#525115").s().p("AgDBCQgUgDgLgNQgOgSgEgaIgBgTQABgOgCgHQgBgGAFgEQAEgDAFADQALAHAFARIAGAcQADALAJAJQAJAMAIgJQAMgNgBgYQgBgKgGggQgBgKAJgGQAJgGAHAIQASAXgCAnQgCAqgXARQgKAIgOAAIgIgBg");
        this.shape_2.setTransform(-0.9, -61.1);

        this.shape_3 = new cjs.Shape();
        this.shape_3.graphics.f("#525115").s().p("Ag7B0QgqgdARgqQACgFAEgBQAFgBAEADQAHAHAJAQQAJAQAHAHQAaAXALgeQAGgSABgfQABg2gGg5IgFABQgvAIgLgXQgDgIAEgGQAEgGAHAAIAAAAQAiAEAhgMQAsgNAYAOQAEADAAAEQAAAEgEADQgVAPgnAIQANAjAABDQAAApgCALQgEAegSAPQgPAOgTAAQgTAAgVgNg");
        this.shape_3.setTransform(-2.4, -83.7);

        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#525115").s().p("");
        this.shape_4.setTransform(0, -57.5);

        this.shape_5 = new cjs.Shape();
        this.shape_5.graphics.f("#FEFF38").s().p("AkKIpQAGhdAHjmIAHjUQgtgDgzgJQhkgRgcgcIDokHQDpkGALACQAKABBEAsQBMAyBMA4QDYClAUBWQgpAghZAtIhRAmIA2HQQh5AwiFAoQi5A4hXAAQglAAgSgKg");
        this.shape_5.setTransform(-0.8, -57.8);

        this.timeline.addTween(cjs.Tween.get({}).to({state: [{t: this.shape_5}, {t: this.shape_4}, {t: this.shape_3}, {t: this.shape_2}, {t: this.shape_1}, {t: this.shape}]}).wait(1));

    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-50.2, -114.9, 100.5, 115);
    ...
    p.nominalBounds = new cjs.Rectangle(0, -447.4, 223.1, 447.4);
    ...
    p.nominalBounds = new cjs.Rectangle(0, -301.7, 132.1, 301.7);
    ...
    p.nominalBounds = new cjs.Rectangle(-8.7, -35.6, 17.5, 35.6);
    ...
    p.nominalBounds = new cjs.Rectangle(-64.4, -181.4, 125.9, 180.8);
    ...
    p.nominalBounds = new cjs.Rectangle(-6.7, -5.4, 13.5, 5.4);
    ...
    p.nominalBounds = new cjs.Rectangle(-2.4, -16.1, 4.8, 16.1);
    ...
    (lib.Tips = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX: 0.98, scaleY: 1, y: -70.9}, 4).to({
            scaleX: 0.92,
            scaleY: 1.08,
            y: -55.4
        }, 3).to({_off: true}, 1).wait(19));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(8).to({_off: false}, 0).to({
            ...
            scaleY: 0.88,
            y: -67.2
        }, 5).to({scaleX: 0.9, scaleY: 1.07, y: -52.2}, 4).to({_off: true}, 1).wait(9));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(18).to({_off: false}, 0).to({
            scaleX: 0.88,
            scaleY: 1.05,
            y: -78.9
        }, 3).to({scaleX: 1, scaleY: 1, y: -63.9}, 5).wait(1));
    ...
    p.nominalBounds = new cjs.Rectangle(-12.1, 0, 821.8, 552.6);
    ...
    (lib.logo = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({_off: false}, 0).wait(6).to({
            regX: 49.4,
            rotation: 0,
            x: 72.6,
            y: 120.5
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(9).to({_off: false}, 0).to({
            rotation: 0,
            x: 183.5,
            y: 126.3
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({_off: false}, 0).to({
            regX: 46.2,
            regY: -34.4,
            rotation: 0,
            x: 181.5,
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(9).to({_off: false}, 0).wait(6).to({
            regX: 92.7,
            regY: -15.2,
            rotation: 0,
            x: 144.7,
    ...
    (lib.EnemyBeaver = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(24).to({_off: false}, 0).to({
            ...
            x: -20,
            y: -89.3
        }, 2).to({regX: -0.2, rotation: 137.2, x: 75.9, y: -50.3}, 5).to({
            rotation: 148.2,
            x: 96.8,
            y: -46.2
        }, 4).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(24).to({_off: false}, 0).to({
            rotation: 18.9,
            x: -7.7,
            y: -79.3
        }, 2).to({rotation: 74.4, x: 58.3, y: 8.7}, 5).to({rotation: 78.4, x: 73.3, y: 9.7}, 4).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(24).to({_off: false}, 0).to({
            regY: -37.6,
            rotation: 14,
            x: -39.9,
            y: -85.8
        }, 2).to({regY: -37.7, rotation: 84.6, x: 11.1, y: -2.8}, 5).to({
            regY: -37.8,
            rotation: 91.6,
            x: 22.2,
            y: -1.8
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(24).to({_off: false}, 0).wait(1).to({
            regX: -0.1,
            regY: -43.7,
            rotation: 8.5,
            x: -6.8,
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(24).to({_off: false}, 0).to({
            regX: 36.9,
            regY: -5.8,
            scaleY: 1.05,
            skewX: 14.7,
            ...
            x: 42.4,
            y: -11.1
        }, 3).to({regX: 37.9, regY: -5.7, scaleY: 0.94, skewX: -4, skewY: 0, x: 39.4, y: -7}, 4).to({
            regX: 37,
            scaleY: 0.94,
            skewX: 0,
            x: 38.5
        }, 4).to({scaleX: 1.02, scaleY: 0.93, skewX: 0.3, y: -6.9}, 2).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(26).to({_off: false}, 0).to({
            regX: 0,
            regY: -21.7,
            rotation: 90.1,
            x: 132.7,
            y: -15.6
        }, 5).to({rotation: 92.4, x: 149.7}, 4).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(24).to({_off: false}, 0).to({
            x: 117.5,
            y: -155.2
        }, 5).to({_off: true}, 1).wait(8));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(24).to({_off: false}, 0).to({
            regX: 0.1,
            rotation: -28.5,
            x: 136.6,
            y: -208.2
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(24).to({_off: false}, 0).to({
            regY: -16,
            rotation: 24,
            x: 151.3,
            y: -127.5
        }, 5).to({regX: 0.1, rotation: -12.2, x: 235.4, y: -7.5}, 3).to({
            rotation: -12.2,
            x: 249.4,
            y: -6.5
        }, 3).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(24).to({_off: false}, 0).to({
            regY: -28.7,
            rotation: 24,
            x: 157.6,
            y: -212.9
        }, 5).to({regY: -28.6, rotation: 63, x: 271.6, y: -27.9}, 3).to({rotation: 73.9, x: 282.6}, 3).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(24).to({_off: false}, 0).to({
            rotation: 24,
            x: 217.9,
            y: -129
        }, 5).to({regX: 0.1, rotation: 99.4, x: 342.9, y: -5.9}, 3).to({x: 355.9, y: -2.9}, 3).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(24).to({_off: false}, 0).to({
            rotation: 24,
            x: 208.3,
            y: -196.8
        }, 5).to({regX: -0.1, rotation: 104, x: 372.4, y: -27.8}, 3).to({x: 387.4}, 3).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(24).to({_off: false}, 0).to({
            regX: 0.1,
            regY: -24.2,
            rotation: 24,
            x: 103.4,
            y: -184.9
        }, 5).to({rotation: 77, x: 211.4, y: -27.8}, 3).to({x: 238.4}, 3).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(24).to({_off: false}, 0).to({
            regX: -0.1,
            rotation: 24,
            x: 142.4,
            y: -75.9
        }, 5).to({x: 180.4, y: -19.9}, 3).to({x: 191.4}, 3).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(24).to({_off: false}, 0).to({
            regX: -0.1,
            rotation: 24,
            x: 192.6,
            y: -171.5
        }, 5).to({rotation: 59.9, x: 309.6, y: -16.5}, 3).to({x: 320.6}, 3).wait(3));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(24).to({_off: false}, 0).to({
            scaleX: 1.19,
            scaleY: 1.16,
            x: 146.7,
            y: -160.7
        }, 2).to({scaleX: 1.75, scaleY: 1.26, x: 257.7, y: -25.6}, 3).to({
            scaleX: 1.81,
            scaleY: 1.41,
            y: -23.6
        }, 1).to({regY: -19.3, scaleX: 1.98, scaleY: 1.84, x: 257.6, y: -17.6}, 3).to({
            regY: -19.4,
            scaleX: 2.1,
            scaleY: 2.14,
            x: 257.7,
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_17).to({
            ...
            x: -31.3,
            y: -90.5
        }, 4).to({regY: -76.1, scaleX: 1.06, scaleY: 0.96, rotation: -7.7, x: -44.8, y: -103.2}, 4).to({
            regY: -76.2,
            scaleX: 1.21,
            scaleY: 0.82,
            rotation: 0,
            x: -32.3,
            y: -88.5
        }, 4).to({regX: -3.9, scaleX: 1.04, scaleY: 1.05, rotation: 4.2, x: -10.1, y: -115.6}, 4).to({
            regX: -4,
            scaleX: 1.21,
            scaleY: 0.82,
            rotation: 0,
            x: -32.3,
            y: -85.5
        }, 4).to({scaleX: 1, scaleY: 1, x: -27.6, y: -98.4}, 3).to({_off: true}, 1).wait(14));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_18).to({
            ...
            x: -16.3,
            y: -3.2
        }, 4).to({regY: -3.7, scaleX: 1.02, scaleY: 1, skewX: -5.4, skewY: -7.7, x: -14.8, y: -8.8}, 4).to({
            regY: -3.8,
            scaleX: 1.17,
            scaleY: 0.86,
            skewX: 0,
            ...
            x: -16.3,
            y: -3.2
        }, 4).to({scaleX: 1.01, scaleY: 1.1, skewX: 5.5, skewY: 7.2, x: -16, y: -6.9}, 4).to({
            scaleX: 1.17,
            scaleY: 0.86,
            skewX: 0,
            skewY: 0,
            x: -16.3,
            y: -3.2
        }, 4).to({scaleX: 1, scaleY: 1, x: -14, y: -3.8}, 3).to({_off: true}, 1).wait(14));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(24).to({scaleX: 0.93, x: 1.1}, 3).to({
            scaleX: 1.09,
            x: -11.4
        }, 4).wait(7));
    ...
    (lib.Spike3 = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY: 0.91, rotation: 2, y: -1.8}, 4).to({
            scaleY: 1,
            rotation: 0,
            y: -1.9
        }, 5).wait(1));
    ...
    (lib.Spike2 = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).to({
            ...
            scaleY: 0.88,
            rotation: -2.2
        }, 5).to({scaleX: 1, scaleY: 1, rotation: 4}, 6).wait(1));
    ...
    (lib.Spike1 = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).to({
            ...
            scaleY: 0.89,
            rotation: -2.5
        }, 4).to({scaleX: 1, scaleY: 1, rotation: 0}, 4).wait(1));
    ...
    (lib.HeroLegs = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get({}).to({
            ...
            }, {t: this.instance, p: {rotation: 0, x: 94.2, y: 70.2, regY: -11.5}}]
        }).to({state: []}, 1).to({
            state: [{
                t: this.instance_1,
                p: {rotation: 91.5, x: 17.8, y: 49.7, regY: -11.5}
            }, {t: this.instance, p: {rotation: -22.2, x: 115.2, y: 54.7, regY: -11.5}}]
        }, 1).to({state: []}, 1).to({
            state: [{
                t: this.instance_1,
                p: {rotation: 138, x: 36.8, y: 48.8, regY: -11.5}
            }, {t: this.instance, p: {rotation: -34.9, x: 114.2, y: 73.7, regY: -11.5}}]
        }, 1).to({state: []}, 1).to({
            state: [{
                t: this.instance_1,
                p: {rotation: 114.3, x: 52.3, y: 48.8, regY: -11.5}
            }, {t: this.instance, p: {rotation: -1.5, x: 69.2, y: 69.7, regY: -11.5}}]
        }, 1).to({state: []}, 1).to({
            state: [{
                t: this.instance_1,
                p: {rotation: -54.2, x: 96.1, y: 58.7, regY: -11.5}
            }, {t: this.instance, p: {rotation: 65.6, x: 53.7, y: 41.2, regY: -11.6}}]
        }, 1).to({state: []}, 1).to({
            state: [{
                t: this.instance_1,
                p: {rotation: -8.3, x: 78.2, y: 72.3, regY: -11.4}
            }, {t: this.instance, p: {rotation: 125.8, x: 70.2, y: 47.8, regY: -11.6}}]
        }, 1).to({state: []}, 1).wait(1));
    ...
    (lib.HeroBullet = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get({}).to({state: []}).to({
            state: [{
                t: this.instance,
                p: {scaleX: 0.667, scaleY: 0.667, x: -1.7, y: 0.1, regY: -8, regX: 0, rotation: 0}
            }]
        }, 7).to({
            state: [{t: this.instance_5}, {t: this.instance_4}, {t: this.instance_3}, {
                ...
                t: this.instance_1,
                p: {regX: -0.1, regY: -2.8, scaleX: 0.603, scaleY: 0.513, skewX: 101.5, skewY: 95.2, x: -1.1, y: 15.4}
            }, {t: this.instance, p: {scaleX: 1, scaleY: 1, x: -1.3, y: -0.6, regY: -8, regX: 0, rotation: 0}}]
        }, 1).to({
            state: [{t: this.shape}, {
                t: this.instance_2,
                p: {
                ...
                t: this.instance_16,
                p: {regY: -8, scaleX: 0.778, scaleY: 0.3, rotation: 0, x: -21.9, y: -20.5}
            }, {
                t: this.instance_15,
                p: {regX: 0, regY: -8, scaleX: 0.553, scaleY: 0.175, rotation: 0, x: -26, y: -16.6}
            }, {
                t: this.instance_14,
                p: {regX: 0, regY: -8, scaleX: 0.492, scaleY: 0.156, rotation: 0, x: -19.8, y: -6}
            }, {
                t: this.instance_13,
                p: {regX: 0.1, regY: -8, scaleX: 0.492, scaleY: 0.156, rotation: -145, x: -23.5}
            }, {
                t: this.instance_12,
                p: {regX: 0.1, regY: -7.9, scaleX: 0.492, scaleY: 0.249, rotation: 154.5, x: -25.8, y: 13.4}
            }, {
                t: this.instance_11,
                p: {regX: -0.1, regY: -8.1, scaleX: 0.492, scaleY: 0.12, rotation: -157, x: -19.8, y: 18.9}
            }, {
                t: this.instance_10,
                p: {regX: 0, regY: -7.8, scaleX: 0.35, scaleY: 0.103, rotation: 0, x: -5.9, y: -5.9}
            }, {
                t: this.instance_9,
                p: {regX: 0.1, regY: -8, scaleX: 0.327, scaleY: 0.103, rotation: 51.2, x: 0.2, y: -4.2}
            }, {
                t: this.instance_8,
                p: {regX: 0, regY: -7.6, scaleX: 0.246, rotation: 0, x: -1.3, y: -2.2}
            }, {
                t: this.instance_7,
                p: {regX: 0, regY: -7.6, scaleX: 0.246, scaleY: 0.072, rotation: 0, x: -3.9, y: 2.8}
            }, {
                t: this.instance_6,
                p: {regX: 0, regY: -7.6, scaleX: 0.246, scaleY: 0.072, rotation: 0, x: -5.6, y: 4.3}
            }, {
                t: this.instance,
                p: {scaleX: 0.246, scaleY: 0.072, x: -1.6, y: 6, regY: -7.6, regX: 0, rotation: 0}
            }, {
                t: this.instance_1,
                p: {regX: 0, regY: -2.7, scaleX: 0.585, scaleY: 0.481, skewX: -90, skewY: 90, x: -1.7, y: 29.1}
            }]
        }, 1).to({
            state: [{t: this.instance_19}, {t: this.instance_18}, {t: this.instance_17}, {
                t: this.instance_16,
                p: {regY: -7.9, scaleX: 0.261, scaleY: 0.078, rotation: -99.8, x: -31.3, y: -26.5}
            }, {
                t: this.instance_15,
                p: {regX: 0.1, regY: -8.1, scaleX: 0.261, scaleY: 0.078, rotation: -31.3, x: -30.3, y: -16.4}
            }, {
                t: this.instance_14,
                p: {regX: 0.1, regY: -8.1, scaleX: 0.261, scaleY: 0.078, rotation: -31.3, x: -37.4, y: -13.9}
            }, {
                t: this.instance_13,
                p: {regX: 0.2, regY: -8.3, scaleX: 0.331, scaleY: 0.078, rotation: -7.5, x: -32.3}
            }, {
                t: this.instance_12,
                p: {regX: 0.4, regY: -8.2, scaleX: 0.331, scaleY: 0.078, rotation: -33.2, x: -32.1, y: 4}
            }, {
                t: this.instance_11,
                p: {regX: 0.2, regY: -9, scaleX: 0.331, scaleY: 0.1, rotation: -5.3, x: -31.5, y: 14.4}
            }, {
                t: this.instance_10,
                p: {regX: 0.1, regY: -8.4, scaleX: 0.331, scaleY: 0.072, rotation: -14.2, x: -32, y: 18}
            }, {
                t: this.instance_9,
                p: {regX: 0.2, regY: -9, scaleX: 0.331, scaleY: 0.1, rotation: -5.3, x: -26, y: 22.8}
            }, {
                t: this.instance_8,
                p: {regX: 0.3, regY: -8.4, scaleX: 0.331, rotation: -44.3, x: -16.6, y: 34.5}
            }, {
                t: this.instance_7,
                p: {regX: 0.1, regY: -9.9, scaleX: 0.331, scaleY: 0.071, rotation: 40.7, x: -18.7, y: 39.6}
            }, {
                t: this.instance_6,
                p: {regX: 0.2, regY: -8.9, scaleX: 0.258, scaleY: 0.078, rotation: -5.3, x: -7.1, y: 42}
            }, {
                t: this.instance,
                p: {scaleX: 0.258, scaleY: 0.092, x: -4.3, y: 41.9, regY: -8.7, regX: 0.1, rotation: -86}
            }]
        }, 1).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_20).to({
            regX: 21.6,
            scaleX: 0.87,
            scaleY: 1.06,
            x: -2.1
        }, 2).to({scaleX: 0.64, scaleY: 1.87, x: -1.6}, 2).to({
            regX: 21.5,
            scaleX: 1.16,
            scaleY: 0.61,
            x: -2.2
        }, 2).to({_off: true}, 1).wait(4));
    ...
    (lib.Hero = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(48).to({_off: false}, 0).wait(1).to({
            regX: 0,
            x: 436.2,
            y: -5.9
        }, 0).wait(1).to({x: 465.1, y: -5.7}, 0).wait(1).to({x: 487.6, y: -5.6}, 0).wait(1).to({
            x: 503.7,
            y: -5.5
        }, 0).wait(1).to({x: 513.3, y: -5.4}, 0).wait(1).to({
            regX: -0.1,
            x: 516.5
        }, 0).to({_off: true}, 7).wait(26).to({
            _off: false,
            regY: -61.9,
            rotation: -168.7,
            x: -3.3,
            y: -53.5
        }, 0).to({regY: -62, rotation: -161.2, x: -2.4, y: -51.5}, 3).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({startPosition: 0}, 0).to({
            regX: -40.1,
            regY: 151.6,
            scaleY: 0.38,
            rotation: -1.4,
            x: 12.3,
            y: -151.6
        }, 5).to({regX: -40.3, regY: 151.5, scaleY: 0.37, rotation: 0, x: 13.3, y: -144.9}, 6).to({
            regX: -40.1,
            regY: 151.6,
            scaleY: 0.38,
            rotation: -1.4,
            x: 12.3,
            y: -151.6
        }, 1).to({startPosition: 0}, 2).to({
            regX: -39.9,
            regY: 151.5,
            rotation: 2.1,
            x: 9.7,
            y: -151.5
        }, 2).to({regX: -40.1, regY: 151.6, rotation: -1.4, x: 12.3, y: -151.6}, 7).to({
            regX: -40.3,
            regY: 151.5,
            scaleY: 0.37,
            rotation: 0,
            x: 13.3,
            y: -145.9
        }, 1).to({regY: 151.6, rotation: 0.7, x: 9.7, y: -256.4}, 2).to({
            regX: -40,
            regY: 151.4,
            rotation: -69,
            x: 1.4,
            y: -277.5
        }, 2).to({regY: 151.5, rotation: -149.9, x: 4.7, y: -298.1}, 2).to({
            regY: 151.3,
            rotation: -219.8,
            x: 5.2,
            y: -286.2
        }, 2).to({regY: 151.2, rotation: -284.8, x: 25.2, y: -258.1}, 2).to({
            regX: -40.3,
            regY: 151.5,
            rotation: -360,
            x: 13.3,
            y: -144.9
        }, 3).to({startPosition: 0}, 1).to({regY: 151.6, rotation: -277, x: 363.7, y: -9.6}, 9).wait(1).to({
            regX: -1.4,
            regY: 0,
            rotation: -276.7,
            x: 457.1,
            y: -1.5
        }, 0).wait(1).to({rotation: -276.5, x: 486.1, y: -1}, 0).wait(1).to({
            rotation: -276.3,
            x: 508.6,
            y: -0.6
        }, 0).wait(1).to({rotation: -276.2, x: 524.7, y: -0.4}, 0).wait(1).to({
            rotation: -276.1,
            x: 534.4,
            y: -0.3
        }, 0).wait(1).to({regX: -40.5, regY: 151.7, x: 479.8, y: -8.7}, 0).to({startPosition: 0}, 6).to({
            regX: -40.3,
            regY: 151.5,
            rotation: -360,
            x: 13.3,
            ...
            x: -10.8,
            y: -76.9
        }, 5).to({startPosition: 0}, 1).to({
            regX: -40.6,
            regY: 151.5,
            rotation: -409.9,
            x: -13.8,
            y: -73.9
        }, 3).to({regX: -40.4, regY: 151.4, rotation: -403.4, x: -10.8, y: -76.9}, 3).to({
            regX: -40.3,
            regY: 151.5,
            rotation: -360,
            x: 13.3,
            y: -144.9
        }, 3).to({startPosition: 0}, 1).to({
            regX: -40.4,
            regY: 151.2,
            rotation: -445.9,
            x: 29.4,
            y: -133.7
        }, 4).to({regY: 151.3, rotation: -442.2, y: -41.7}, 5).to({
            regX: -40.3,
            rotation: -436.9,
            x: 29.3,
            y: -36.8
        }, 2).to({regY: 151.2, rotation: -431.5, y: -31.8}, 2).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({startPosition: 0}, 0).to({
            regX: 27.9,
            scaleX: 0.36,
            scaleY: 0.39,
            rotation: -1.4,
            x: 24.4,
            y: -69.6
        }, 5).to({regX: 28.2, scaleX: 0.37, scaleY: 0.37, rotation: 0, x: 24.5, y: -66.6}, 6).to({
            regX: 27.9,
            scaleX: 0.36,
            scaleY: 0.39,
            rotation: -1.4,
            x: 24.4,
            y: -69.6
        }, 1).to({startPosition: 0}, 2).to({regX: 28, rotation: -2, x: 21.5}, 2).to({
            regX: 27.9,
            rotation: -1.4,
            x: 24.4
        }, 7).to({regX: 28.2, scaleX: 0.37, scaleY: 0.37, rotation: 0, x: 24.5, y: -67.6}, 1).to({
            regX: 28.1,
            regY: 102,
            rotation: -7.2,
            x: 29.5,
            y: -190.1
        }, 2).to({regY: 101.9, rotation: -65.5, x: 72.5, y: -256.8}, 2).to({
            rotation: -129,
            x: 54.9,
            y: -352.4
        }, 2).to({regY: 101.8, rotation: -193.7, x: -22.4, y: -354.8}, 2).to({
            regX: 27.9,
            regY: 101.9,
            rotation: -258.7,
            x: -48.8,
            ...
            x: 359.3,
            y: -11.2
        }, 0).wait(1).to({rotation: -261.9, x: 388.5, y: -10}, 0).wait(1).to({
            rotation: -260.6,
            x: 411.2,
            y: -9.1
        }, 0).wait(1).to({rotation: -259.6, x: 427.4, y: -8.5}, 0).wait(1).to({
            rotation: -259.1,
            x: 437.1,
            y: -8.1
        }, 0).wait(1).to({
            ...
            x: 400.9,
            y: -4.6
        }, 0).to({startPosition: 0}, 6).to({regX: 28.2, rotation: -360, x: 24.5, y: -66.6}, 1).to({
            regX: 27.9,
            regY: 101.9,
            rotation: -398.4,
            x: 52.5,
            y: -34.7
        }, 5).to({startPosition: 0}, 1).to({regX: 28.2, regY: 101.6, rotation: -401.9}, 3).to({
            regX: 27.9,
            regY: 101.9,
            rotation: -398.4
        }, 3).to({
            ...
            x: 92,
            y: -86.7
        }, 4).to({regX: 28.2, regY: 101.8, rotation: -475.4, x: 92.8, y: -85.7}, 5).to({
            regX: 27.9,
            regY: 101.9,
            rotation: -459,
            x: 101.1,
            y: -63.5
        }, 2).to({regX: 28.2, rotation: -442.7, x: 109.4, y: -41.3}, 2).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({startPosition: 0}, 0).to({
            regY: -81.8,
            scaleY: 0.35,
            rotation: 14,
            x: -52.8,
            y: -84.1
        }, 5).to({regY: -81.7, scaleY: 0.37, rotation: 0, x: -45.9, y: -79.3}, 6).to({
            regX: -18.9,
            regY: -81.8,
            scaleY: 0.35,
            rotation: 8.5,
            x: -47.3,
            y: -80.1
        }, 1).to({regX: -18.8, rotation: 14, x: -52.8, y: -84.2}, 2).to({
            regX: -18.9,
            regY: -81.7,
            rotation: 8.3,
            x: -52.5,
            y: -81
        }, 2).to({regX: -18.8, regY: -81.8, rotation: 14, x: -52.8, y: -84.1}, 7).to({
            regY: -81.7,
            scaleY: 0.37,
            rotation: 0,
            x: -45.9,
            y: -80.3
        }, 1).to({regX: -18.7, regY: -81.8, rotation: -18.9, x: -28.6, y: -189.3}, 2).to({
            regX: -18.5,
            regY: -81.7,
            rotation: -64.5,
            x: 33,
            y: -198.6
        }, 2).to({regX: -18.6, rotation: -128.2, x: 88.4, y: -289.5}, 2).to({
            regX: -18.5,
            rotation: -211.6,
            x: 27.9,
            y: -363.3
        }, 2).to({regY: -81.6, rotation: -252.9, x: -17.9, y: -331.5}, 2).to({
            regX: -18.8,
            regY: -81.7,
            rotation: -360,
            x: -45.9,
            ...
            x: 292.6,
            y: -55.5
        }, 9).wait(1).to({regX: 0.7, regY: 0, rotation: -258.4, x: 296.1, y: -51.2}, 0).wait(1).to({
            rotation: -260.7,
            x: 324.7,
            y: -47.2
        }, 0).wait(1).to({rotation: -262.5, x: 346.9, y: -44.2}, 0).wait(1).to({
            rotation: -263.8,
            x: 362.8,
            y: -42
        }, 0).wait(1).to({rotation: -264.5, x: 372.4, y: -40.6}, 0).wait(1).to({
            regX: -18.9,
            regY: -81.8,
            rotation: -264.8,
            x: 406.5,
            y: -44.7
        }, 0).to({regY: -81.4, rotation: -263.3}, 6).to({
            regX: -18.8,
            regY: -81.7,
            rotation: -360,
            x: -45.9,
            ...
            x: -62.8,
            y: -13
        }, 3).to({regX: -18.9, regY: -81.8, rotation: -297.5, x: -60.4, y: -10.9}, 3).to({
            regX: -18.8,
            regY: -81.7,
            rotation: -360,
            x: -45.9,
            y: -79.3
        }, 3).to({startPosition: 0}, 1).to({regX: -18.9, rotation: -421.9, x: 49.5, y: -48.9}, 4).to({
            regX: -18.7,
            regY: -81.8,
            rotation: -496.4,
            x: 109.5,
            y: -39
        }, 5).to({regY: -81.9, rotation: -451.9, x: 93.5, y: 18.6}, 4).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({startPosition: 0}, 0).to({
            regX: 51,
            regY: -81.9,
            rotation: 5.8,
            x: -9.7,
            y: -138
        }, 5).to({regX: 50.9, regY: -81.7, rotation: 0, x: -8.5, y: -137.1}, 6).to({
            regX: 51,
            regY: -81.9,
            rotation: 0.3,
            x: -9.4,
            y: -137.8
        }, 1).to({regX: 50.9, regY: -82, rotation: 5.8, x: -9.7, y: -138}, 2).to({
            regX: 50.6,
            regY: -81.8,
            rotation: 1.4,
            x: -13.7
        }, 2).to({regX: 51, regY: -81.9, rotation: 5.8, x: -9.7}, 7).to({
            regX: 50.9,
            regY: -81.7,
            rotation: 0,
            x: -8.5,
            y: -138.1
        }, 1).to({regX: 50.8, rotation: -18.9, x: -12, y: -256.1}, 2).to({
            regX: 51,
            rotation: -64.5,
            x: -3.2,
            y: -257.3
        }, 2).to({regX: 51.1, rotation: -128.2, x: 19.8, y: -283.1}, 2).to({
            regY: -81.8,
            rotation: -211.6,
            x: 26.4,
            y: -294.4
        }, 2).to({regX: 51.2, regY: -81.9, rotation: -252.9, x: 26.6, y: -278.7}, 2).to({
            regX: 50.9,
            regY: -81.7,
            rotation: -360,
            x: -8.5,
            ...
            x: 357.6,
            y: -32.8
        }, 9).wait(1).to({regX: -0.6, regY: 0, rotation: -287, x: 358.2, y: -42.1}, 0).wait(1).to({
            rotation: -289.7,
            x: 386.8,
            y: -40.4
        }, 0).wait(1).to({rotation: -291.7, x: 409.1, y: -39.1}, 0).wait(1).to({
            rotation: -293.2,
            x: 425.1,
            y: -38.1
        }, 0).wait(1).to({rotation: -294, x: 434.6, y: -37.5}, 0).wait(1).to({
            regX: 51,
            regY: -81.8,
            rotation: -294.3,
            x: 473.6,
            y: -32.4
        }, 0).to({startPosition: 0}, 6).to({
            regX: 50.9,
            regY: -81.7,
            rotation: -360,
            x: -8.5,
            ...
            x: -16.3,
            y: -63.7
        }, 3).to({regX: 51.1, regY: -81.9, rotation: -353.3, x: -16.5, y: -63.9}, 3).to({
            regX: 50.9,
            regY: -81.7,
            rotation: -360,
            x: -8.5,
            y: -137.1
        }, 3).to({startPosition: 0}, 1).to({regX: 51, rotation: -421.9, x: 16.1, y: -109.2}, 4).to({
            regX: 51.1,
            rotation: -496.4,
            x: 42.4,
            y: -22.9
        }, 5).to({regX: 50.9, rotation: -451.9, x: 34.3, y: -16.9}, 4).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({startPosition: 0}, 0).to({
            regY: 127.2,
            rotation: 9.5,
            x: 83.5,
            y: -132.8
        }, 5).to({regY: 127.4, rotation: 0, x: 82.5, y: -134.2}, 6).to({
            regY: 127.2,
            rotation: 9.5,
            x: 83.5,
            y: -132.8
            ...
            x: 82.5,
            y: -135.2
        }, 0).to({regX: 4.1, regY: 127.5, rotation: 30, x: 70, y: -230.8}, 2).to({
            regX: 4.2,
            regY: 127.6,
            rotation: -28.3,
            x: 59.3,
            y: -312.6
        }, 2).to({regY: 127.8, rotation: -91.8, x: -0.9, y: -365.4}, 2).to({
            regY: 127.7,
            rotation: -180.7,
            x: -61,
            y: -286.9
        }, 2).to({regY: 127.8, rotation: -245.7, x: -3.4, y: -198.4}, 2).to({
            regX: 4,
            regY: 127.4,
            rotation: -360,
            x: 82.5,
            y: -134.2
        }, 3).to({startPosition: 0}, 1).to({regY: 127.3, rotation: -294.3, x: 396.7, y: 32.4}, 9).wait(1).to({
            regX: 0.4,
            regY: 1.8,
            rotation: -298.7,
            x: 474.5,
            y: 5.7
        }, 0).wait(1).to({rotation: -302.3, x: 503.6, y: 0.8}, 0).wait(1).to({
            rotation: -305.1,
            x: 526,
            y: -3
        }, 0).wait(1).to({rotation: -307.1, x: 542, y: -5.7}, 0).wait(1).to({
            rotation: -308.3,
            x: 551.6,
            y: -7.3
        }, 0).wait(1).to({
            ...
            x: 82.5,
            y: -134.2
        }, 1).to({regY: 127.3, rotation: -419.9, x: 34.4, y: -135.2}, 5).to({startPosition: 0}, 1).to({
            regX: 4.2,
            regY: 127.2,
            rotation: -426.4,
            x: 27.9,
            y: -137.4
        }, 3).to({regX: 4, regY: 127.3, rotation: -419.9, x: 34.4, y: -135.2}, 3).to({
            regY: 127.4,
            rotation: -360,
            x: 82.5,
            y: -134.2
        }, 3).to({startPosition: 0}, 1).to({regX: 4.2, rotation: -439.2, x: 52.6, y: -168.2}, 4).to({
            regY: 127.6,
            rotation: -472,
            x: 15.2,
            y: -105.4
        }, 5).to({regY: 127.5, rotation: -490.3, x: -2.9, y: -81.1}, 4).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(15).to({_off: false}, 0).wait(2).to({
            regX: 54.1,
            rotation: 3.7,
            x: 121.5
        }, 0).to({
            ...
            x: 78.8,
            y: -217.7
        }, 3).wait(1).to({skewX: -67.6, skewY: -69.8}, 0).to({
            skewX: -59.9,
            skewY: -62.1,
            x: 96.3,
            y: -176.2
        }, 3).to({_off: true}, 1).wait(66));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({startPosition: 0}, 0).to({
            regY: -33.6,
            rotation: 8,
            x: 28.1,
            y: -142.3
        }, 5).to({regY: -33.5, rotation: 0, x: 26.4, y: -135.8}, 6).to({
            regY: -33.6,
            rotation: 8,
            x: 28.1,
            y: -142.3
            ...
            x: 26.4,
            y: -143.8
        }, 0).to({_off: true}, 1).wait(6).to({_off: false, regY: -33.4, rotation: -42.2}, 0).to({
            regY: -33.5,
            rotation: 6
        }, 3).wait(1).to({scaleX: 0.37, rotation: 0, y: -136.8}, 0).to({
            regX: -81.5,
            regY: -33.4,
            rotation: 30,
            x: 22.3,
            y: -260.2
        }, 2).to({rotation: -28.3, x: 9.1, y: -287.5}, 2).to({rotation: -91.8, x: -0.9, y: -309.4}, 2).to({
            regX: -81.4,
            regY: -33.2,
            rotation: -180.7,
            x: -4.8,
            y: -285.9
        }, 2).to({rotation: -245.7, x: 21.2, y: -248.9}, 2).to({
            regX: -81.7,
            regY: -33.5,
            rotation: -360,
            x: 26.4,
            ...
            x: 374.9,
            y: -19.3
        }, 9).wait(1).to({regX: -0.8, regY: -0.1, rotation: -298.7, x: 412.3, y: 12.3}, 0).wait(1).to({
            rotation: -302.3,
            x: 441.9,
            y: 11.3
        }, 0).wait(1).to({rotation: -305.1, x: 464.9, y: 10.4}, 0).wait(1).to({
            rotation: -307.1,
            x: 481.3,
            y: 9.7
        }, 0).wait(1).to({rotation: -308.3, x: 491.2, y: 9.3}, 0).wait(1).to({
            regX: -82,
            regY: -33.2,
            rotation: -308.7,
            x: 485.1,
            ...
            x: 26.4,
            y: -135.8
        }, 1).to({regX: -81.9, rotation: -419.9, x: 4.8, y: -87.4}, 5).to({startPosition: 0}, 1).to({
            regX: -81.5,
            regY: -33.3,
            rotation: -426.4,
            x: 4,
            y: -86.5
        }, 3).to({regX: -81.9, regY: -33.5, rotation: -419.9, x: 4.8, y: -87.4}, 3).to({
            regX: -81.7,
            rotation: -360,
            x: 26.4,
            y: -135.8
        }, 4).to({regX: -81.6, rotation: -439.2, x: 40.4, y: -113.4}, 4).to({
            regX: -81.5,
            rotation: -472,
            x: 34.6,
            y: -52.7
        }, 5).to({regX: -81.7, rotation: -490.3, x: 32, y: -37.1}, 4).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.armshoot).wait(15).to({_off: false}, 0).wait(2).to({x: 54.4}, 0).to({
            regY: -51.5,
            scaleX: 0.35,
            rotation: -43.7,
            x: 47.5,
            y: -160.3
        }, 3).to({_off: true}, 1).wait(70));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(39).to({_off: false}, 0).to({
            regX: -0.1,
            regY: -114.9,
            rotation: -19.8,
            x: 262.2,
            ...
            x: 292.4,
            y: -13.9
        }, 0).wait(1).to({rotation: -17.6, x: 321.4, y: -14.2}, 0).wait(1).to({
            rotation: -16.8,
            x: 344,
            y: -14.5
        }, 0).wait(1).to({rotation: -16.3, x: 360.1, y: -14.7}, 0).wait(1).to({
            rotation: -15.9,
            x: 369.8,
            y: -14.8
        }, 0).wait(1).to({
            ...
            x: 378.2,
            y: -15.8
        }, 0).to({_off: true}, 7).wait(28).to({
            _off: false,
            regX: -0.4,
            rotation: 150.2,
            x: 133.2,
            y: -45.7
        }, 0).wait(1).to({regX: -0.3, rotation: 156.7, y: -33.7}, 0).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(25).to({_off: false}, 0).to({
            regX: 130.9,
            regY: 25.7,
            rotation: -19.7,
            x: 32.3,
            y: -197
        }, 2).to({regX: 131.1, regY: 25.8, rotation: -77.9, x: 68.2, y: -262.9}, 2).to({
            regX: 130.9,
            rotation: -127.9,
            x: 47.5,
            y: -351.2
        }, 2).to({regX: 131, regY: 25.7, rotation: -188.6, x: -24.5, y: -347.7}, 2).to({
            regX: 130.9,
            regY: 25.8,
            rotation: -266.4,
            x: -42.1,
            y: -256.1
        }, 2).to({regX: 130.8, regY: 25.9, rotation: -360, x: 26.9, y: -67.3}, 3).to({_off: true}, 1).wait(52));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(62).to({_off: false}, 0).to({
            scaleX: 0.4,
            scaleY: 0.42,
            x: 64.5,
            y: -30
        }, 4).wait(1).to({startPosition: 0}, 0).to({scaleX: 0.41, scaleY: 0.41, x: 67, y: -29}, 3).to({
            scaleX: 0.4,
            scaleY: 0.42,
            x: 64.5,
            y: -30
        }, 3).to({scaleX: 0.33, scaleY: 0.69, x: 35, y: -49.5}, 3).to({_off: true}, 1).wait(14));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(62).to({_off: false}, 0).to({
            rotation: -12.2,
            x: 123,
            y: -6.4
        }, 4).wait(1).to({x: 126}, 3).to({x: 123}, 3).to({
            rotation: -16.7,
            x: 83,
            y: -5.9
        }, 3).to({_off: true}, 1).wait(14));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(62).to({_off: false}, 0).to({
            rotation: 114.5,
            x: 3
        }, 4).wait(1).to({rotation: 117.5, x: 3.9, y: -9.3}, 3).to({
            rotation: 114.5,
            x: 3,
            y: -9.4
        }, 3).to({rotation: 8.7, x: -16.9}, 3).to({_off: true}, 1).wait(14));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(3).to({startPosition: 2}, 0).wait(2).to({startPosition: 4}, 0).wait(2).to({startPosition: 6}, 0).wait(2).to({startPosition: 8}, 0).wait(2).to({startPosition: 10}, 0).wait(2).to({startPosition: 0}, 0).wait(2).to({startPosition: 2}, 0).wait(2).to({startPosition: 4}, 0).wait(2).to({startPosition: 6}, 0).wait(2).to({startPosition: 8}, 0).wait(2).to({startPosition: 10}, 0).to({_off: true}, 2).wait(36).to({
            _off: false,
            startPosition: 0
        }, 0).to({_off: true}, 1).wait(15).to({_off: false}, 0).to({
            rotation: -41.2,
            x: 104.1,
            y: -58.8
        }, 4).to({rotation: -126.5, x: 127.1, y: -100.7}, 4).to({
            regY: 42.8,
            rotation: -98.6,
            x: 131.1,
            y: -59.8
        }, 3).to({_off: true}, 1).wait(2));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(25).to({
            regX: 77.9,
            scaleX: 0.35,
            scaleY: 0.35
        }, 7).wait(2).to({regX: 78, scaleX: 0.6, scaleY: 0.6}, 4).wait(1).to({
            regX: 77.9,
            scaleX: 1.83,
            scaleY: 0.72,
            x: 364,
            y: 23.9
        }, 9).to({x: 468}, 6, cjs.Ease.get(1)).wait(7).to({
            regX: 78,
            scaleX: 0.6,
            scaleY: 0.6,
            x: 23.5,
            y: -0.1
        }, 0).to({scaleX: 1.08, x: 61}, 5).wait(11).to({scaleX: 0.6, x: 23.5}, 0).to({
            regX: 77.9,
            scaleX: 1.2,
            x: 46.4
        }, 6).wait(8));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(48).to({_off: false}, 0).to({
            scaleX: 2.13,
            x: 414.1
        }, 6).to({scaleX: 2.24, scaleY: 1.22, x: 422.5, y: 27.7}, 6).to({_off: true}, 1).wait(28).to({
            _off: false,
            scaleX: 1,
            scaleY: 1,
            rotation: -0.5,
            x: 49.5,
            y: -3
        }, 0).wait(1).to({scaleX: 1.09}, 0).wait(1));
    ...
    (lib.EnemyMoose = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(16).to({_off: false}, 0).to({
            ...
            x: -4.2,
            y: -170.6
        }, 4).to({regX: 0, rotation: 5, x: -0.7, y: -174.6}, 2).to({
            regX: 0.1,
            regY: -54.6,
            rotation: 1.5,
            x: 12.3,
            y: -27
        }, 5).to({regX: 0, scaleX: 1.25, scaleY: 0.58, rotation: 1.7, x: 11.6, y: -11.8}, 2).to({
            regX: 0.1,
            scaleX: 1.06,
            scaleY: 0.89,
            rotation: 1.5,
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).to({
            ...
            scaleY: 0.93,
            y: -147.5
        }, 2).to({scaleX: 0.91, scaleY: 1.13, y: -206}, 3).to({scaleY: 1.09, y: -212.5}, 2).to({
            scaleX: 1.08,
            scaleY: 0.93,
            y: -147.5
        }, 3).to({regY: -54.7, scaleX: 1.12, scaleY: 0.88, y: -140.9}, 2).to({
            regY: -54.6,
            scaleX: 1,
            scaleY: 1,
            y: -157
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(16).to({_off: false}, 0).to({
            rotation: -3.2,
            x: 4.3,
            y: -213.1
        }, 5).to({rotation: -0.3, x: 11.3, y: -119.6}, 6).to({
            scaleX: 1.1,
            scaleY: 0.83,
            rotation: -0.3,
            y: -118.6
        }, 3).to({scaleX: 1.04, scaleY: 0.89, y: -119.6}, 2).wait(5));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(27).to({_off: false}, 0).to({
            regX: 0.5,
            scaleX: 0.97,
            scaleY: 0.64,
            y: -124.9
        }, 3).to({scaleX: 0.98, scaleY: 1}, 3).wait(4));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(16).to({_off: false}, 0).to({
            ...
            rotation: 7.7,
            y: -13.4
        }, 3).to({regX: 52, regY: -1.4, rotation: 0, y: -13.3}, 4).wait(4).to({
            regY: -1.5,
            scaleX: 1.02,
            scaleY: 0.98,
            x: 48.9
        }, 3).to({regY: -1.4, scaleX: 1, scaleY: 1, x: 48.5}, 2).wait(5));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_5).to({scaleX: 1.03, scaleY: 0.95}, 2).to({
            scaleX: 0.89,
            scaleY: 1.14,
            y: -42
        }, 3).to({regX: -0.6, scaleY: 1.07, x: -3.9, y: -59}, 2).to({
            regX: -0.5,
            scaleX: 1.03,
            scaleY: 0.95,
            x: -3.8,
            y: -18.5
        }, 3).to({regX: -0.6, regY: 90.1, scaleX: 1.08, scaleY: 0.9, x: -4, y: -18.4}, 2).to({
            regX: -0.5,
            regY: 90,
            scaleX: 1,
            scaleY: 1,
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(16).to({_off: false}, 0).to({
            regY: -18.4,
            scaleX: 0.75,
            scaleY: 0.75,
            rotation: -52.6,
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(16).to({_off: false}, 0).to({
            regY: -18.4,
            rotation: 77,
            x: 200.5,
            y: -70
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(16).to({_off: false}, 0).to({
            scaleX: 1,
            scaleY: 1,
            rotation: 54.7,
            x: 128,
            y: -118.7
        }, 3).to({scaleX: 1, scaleY: 1, rotation: 91, x: 178, y: -111.7}, 2).to({_off: true}, 1).wait(15));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(16).to({_off: false}, 0).to({
            rotation: 32.7,
            x: 124.2,
            y: -86.4
        }, 3).to({_off: true}, 1).wait(17));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(16).to({_off: false}, 0).to({
            scaleX: 1.41,
            scaleY: 1.41,
            rotation: -21.3,
            x: 119.4,
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(16).to({_off: false}, 0).to({
            regX: -0.1,
            scaleX: 1.41,
            scaleY: 1.41,
            rotation: -2.2,
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_12).to({
            ...
            x: -100.1,
            y: -157.3
        }, 2).to({regX: 0.1, skewX: -4.2, skewY: 175.8, x: -93.6, y: -202.8}, 3).to({
            skewX: 2,
            skewY: 182,
            x: -93.7,
            y: -211.3
        }, 2).to({regX: 0, skewX: 6.7, skewY: 186.7, x: -100.1, y: -157.3}, 3).to({
            regX: 0.1,
            skewX: 5.5,
            skewY: 185.5,
            x: -105.6,
            y: -149.3
        }, 2).to({regX: 0, skewX: 0, skewY: 180, x: -99.6, y: -163.8}, 3).wait(1).to({
            regX: -0.1,
            skewX: -60.6,
            skewY: 119.4,
            x: -95.4,
            y: -72.4
        }, 5).to({skewX: -5.6, skewY: 174.4, x: -83.4, y: -69.7}, 5).to({
            skewX: -8.1,
            skewY: 171.9,
            x: -85.4
        }, 6).wait(5));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_13).to({
            ...
            x: 89.5,
            y: -160.3
        }, 2).to({rotation: 7.7, x: 85, y: -204.8}, 3).to({
            regY: -31.5,
            rotation: -4.3,
            x: 84.5,
            y: -213.3
        }, 2).to({regY: -31.4, rotation: -6.7, x: 89.5, y: -160.3}, 3).to({
            rotation: -5,
            x: 97,
            y: -150.3
        }, 2).to({rotation: 0, x: 92, y: -163.8}, 3).wait(1).to({
            regX: 0.1,
            regY: -31.5,
            rotation: -31,
            x: 98.5,
            y: -66.8
        }, 5).to({rotation: 20.7, x: 109, y: -61.7}, 5).to({regX: 0, rotation: 6.5, x: 108.4}, 6).wait(5));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_14).to({scaleX: 1.05, scaleY: 1.05}, 2).to({
            scaleX: 0.86,
            scaleY: 0.86
        }, 3).wait(2).to({scaleX: 1.05, scaleY: 1.05}, 3).wait(2).to({scaleX: 1, scaleY: 1}, 3).wait(22));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(27).to({_off: false}, 0).to({
            regY: -21,
            scaleX: 1.23,
            scaleY: 0.72,
            y: 12.4
        }, 3).to({scaleX: 1.26, scaleY: 0.84}, 4).to({regY: -20.9, scaleX: 1.27, scaleY: 0.91, y: 12.5}, 2).wait(1));
    ...
    (lib.Menu = function (mode, startPosition, loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({
            ...
            startPosition: 12,
            loop: false
        }, 0).to({x: 348, startPosition: 1}, 12).to({x: 588}, 12).to({
            x: 838,
            startPosition: 13
        }, 12).to({_off: true}, 1).wait(6));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(5).to({_off: false}, 0).to({
            x: 611.4,
            mode: "synched",
            startPosition: 7,
            loop: false
        }, 5).to({_off: true}, 4).wait(30));
        ...
        this.timeline.addTween(cjs.Tween.get(this.enemyBeaver).wait(10).to({
            regY: -109.6,
            y: 410.2,
            mode: "synched",
            startPosition: 24,
            loop: false
        }, 0).to({_off: true}, 33).wait(1));
...
// stage content:
    (lib.PlanetaryGary_art_Canvas = function (mode, startPosition, loop) {
        this.initialize(mode, startPosition, loop, {});
